...
test.beforeAll(async ({ browser }) => {
  ...
  dataProviderForWP.forEach(MiltipleWpData =>{
    test(`TC_02-Add Locations in Salesforce ${MiltipleWpData.workPackage}`, async({ })=>{
      const createOppy = new CreateOppy(tab0, test.info());
      await createOppy.addLocation(MiltipleWpData.location);
  ...
  dataProviderForWP.forEach(MiltipleWpData =>{
    test(`TC_01-Creating a work package ${MiltipleWpData.workPackage}`, async({ })=>{
      ...
      await workPackagePage2.createESWorkPackage(MiltipleWpData.workPackageName);
  ...
  test(`TC_02-Add cost items ${MiltipleWpData.workPackage}`, async ({  }) => {
  ...
  test(`TC_03-Submit Work Package ${MiltipleWpData.workPackage}`, async ({ }) => {
  ...
  WpProjectMngrData.forEach(projectMngrData =>{
    test(`TC_02-update Office and People section ${projectMngrData.workPackage}`, async({ })=>{
      const cpPage = new CreditProject(tab1, test.info());
